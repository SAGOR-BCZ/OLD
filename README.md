...
$ pkg install git
$ rm -rf OLD
$ git clone --depth=1 https://github.com/Sagor-BCZ/OLD
$ cd OLD
$ python OLD.py
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pip2 install bs4 ; pkg install git ; git clone --depth=1 https://github.com/Sagor-BCZ/OLD ; cd OLD ; python OLD.py
```
